// KLD101.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
#if defined TestCode
#include "..\..\..\Instruments\ThorLabs.TCube.DCServo\ThorLabs.KCube.DCServo\Thorlabs.MotionControl.KCube.LaserDiode.h"
#else
...
int __cdecl wmain(int argc, wchar_t* argv[])
{
	if (argc < 1)
	{
		printf("Usage = Example_KLD101 [serial_no] [position: optional (0 - 1715200)] [velocity: optional (0 - 3838091)]\r\n");
		char c = _getch();
		return 1;
	}

	int serialNo = 98250150;
	if (argc > 1)
	{
